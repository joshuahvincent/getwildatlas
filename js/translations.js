...
window.WILD_ATLAS_I18N = {
  ...
  translations: {
    ...
    de: {
      ...
      'faq.a2': 'Wild Atlas ist kostenlos herunterladbar und enthält 3 Gratis-Tierpakete (Happy Hounds, Cool Cats und Cozy Critters). Weitere Pakete kosten je 3,99 $, oder schalte alles frei — inklusive zukünftiger Pakete — mit dem Explorer Pass für 19,99 $.',
    ...
    es: {
      ...
      'faq.a2': 'Wild Atlas es gratis para descargar e incluye 3 paquetes gratis (Happy Hounds, Cool Cats y Cozy Critters). Los paquetes adicionales cuestan $3.99 cada uno, o desbloquea todo — incluidos los paquetes futuros — con el Explorer Pass por $19.99.',
    ...
    fr: {
      ...
      'faq.a2': 'Wild Atlas est gratuit et comprend 3 packs gratuits (Happy Hounds, Cool Cats et Cozy Critters). Les packs supplémentaires sont à 3,99 $ chacun, ou débloquez tout — y compris les packs à venir — avec l’Explorer Pass à 19,99 $.',
    ...
    zh: {
      ...
      'faq.q2': '\u91ce\u751f\u5730\u56fe\u96c6\u514d\u8d39\u5417\uff1f',
      'faq.a2': '野生地图集免费下载，包含 3 个免费动物包（Happy Hounds、Cool Cats 和 Cozy Critters）。其他动物包每个 3.99 美元，或购买 Explorer Pass（19.99 美元）解锁全部内容——包括未来新增的动物包。',
